      ...
      processor (p)
{
    ...
    freqSlider.setValue(15000);
    freqSlider.setBounds (20, 140, 250, 20);
    freqSlider.setSkewFactor(1.5);
...
void OverdriveAudioProcessorEditor::timerCallback()
{
    ...
    inputGainSlider.setValue(*processor.inputGainParam, dontSendNotification);
    outputGainSlider.setValue(*processor.outputGainParam, dontSendNotification);
    freqSlider.setValue(*processor.freq, dontSendNotification);
}
